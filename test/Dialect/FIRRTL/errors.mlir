...
firrtl.circuit "InvalidOption" {
  ...
  firrtl.module @InvalidOption() {
    // expected-error @below {{case refence @Bad::@FPGA is invalid}}
...
firrtl.circuit "InvalidCase" {
  ...
  firrtl.module @InvalidCase() {
    // expected-error @below {{case refence @Platform::@BAD is invalid}}
...
firrtl.circuit "InvalidCaseTarget" {
  ...
  firrtl.module @InvalidCaseTarget() {
    // expected-error @below {{op case refence @BadPlatform::@FPGA is invalid}}
